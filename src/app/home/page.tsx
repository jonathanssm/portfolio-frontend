    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-8">
            <section className="text-center space-y-4">
                <h1 className="text-3xl font-bold">👋 Olá, eu sou Jonathan Moraes</h1>
            ...
            <section className="text-center space-y-4">
                <h2 className="text-2xl font-semibold">🚀 Tecnologias & Ferramentas</h2>
                ...
                {experiencias.map((exp, idx) => (
                    <Card key={idx} className="mb-4">
                        <CardContent className="p-4 space-y-2">
                            ...
                            <p className="text-muted-foreground">{exp.projeto}</p>
                            <ul className="list-disc list-inside text-sm space-y-1">
                                {exp.atividades.map((a, i) => (
                                    <li key={i}>{a}</li>
                                ))}
                            </ul>
                            <p className="text-sm text-muted-foreground">Stack: {exp.stack}</p>
                        </CardContent>
                    </Card>
                ))}
            </section>
            ...
            <section className="space-y-4">
                <h2 className="text-2xl font-semibold">📜 Certificações</h2>
                <Card>
                    <CardContent className="p-4 space-y-2">
